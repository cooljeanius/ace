...
define(function (require, exports, module) {
  ...
  var allowedCommands = {
    initSender: function(clazz) {
      sender = window.sender = new Sender();
      main = window.main = new clazz(sender);
    },
    updateRequireConfig: function(config) {
  ...
  // Removed window.updateRequireConfig as it is now part of allowedCommands
  ...
  window.onmessage = function (e) {
    ...
    if (msg.event && sender) {
      ...
      else if (allowedCommands[msg.command]) allowedCommands[msg.command].apply(null, msg.args);
